...
func TestOpenCreatesDirectoryAndSchema(t *testing.T) {
	...
	want := []string{"admin_tokens", "device_scenarios", "devices", "events", "scenario_draft_history", "scenario_drafts", "scenarios", "schema_migrations", "session_devices", "sessions"}
...
func TestInfoReportsEmptyDatabase(t *testing.T) {
	...
	want := map[string]int64{"admin_tokens": 0, "device_scenarios": 0, "devices": 0, "events": 0, "scenario_draft_history": 0, "scenario_drafts": 0, "scenarios": 0, "schema_migrations": int64(count), "session_devices": 0, "sessions": 0}
